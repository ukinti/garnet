...
UserID: contextvars.ContextVar[Optional[int]] = contextvars.ContextVar("CurrentUser", default=None)
ChatID: contextvars.ContextVar[Optional[int]] = contextvars.ContextVar("CurrentChat", default=None)
